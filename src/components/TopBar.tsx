...
export default function TopBar({ onHome, onNavigateToLetter, onMenuToggle }: TopBarProps) {
  ...
  return (
    ...
    >
        ...
        <div className="relative flex-shrink-0" style={{ width: '36px', height: '36px' }}>
          <img
            ...
            style={{
              ...
              filter: 'brightness(0.75) saturate(0.6) sepia(0.4) hue-rotate(80deg)',
            }}
          />
      ...
      <div className="absolute left-1/2 -translate-x-1/2 text-center pointer-events-none">
        ...
        <p style={{ color: '#9CAF88', opacity: 0.75, fontSize: '9px' }}>{dateStr}</p>
        <p className="font-mono font-semibold" style={{ color: '#DFF5E1', fontSize: '10px', letterSpacing: '0.05em' }}>{timeStr}</p>
      </div>
